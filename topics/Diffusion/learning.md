# Learning - Aditya
## What is DDIM and what is difference from DDPM?
**T:** Basic
...
## How are few-step diffusion models trained while maintaining consistency?
**T:** Deep
...
## Difference between distillation and sampler (or scheduler)?
**T:** Basic
...
## How is self-attention and cross-attention utilized in diffusion architectures?
**T:** Basic
...
## What is the start-up problem in multi-step solvers, and how is it addressed?
**T:** Deep
...
## Can we do KV caching in diffusion?
**T:** Deep
...
## How can forward passes be reused to accelerate diffusion?
**T:** Deep
...
## How can diffusion be interpreted in an RL setting?
**T:** Deep
